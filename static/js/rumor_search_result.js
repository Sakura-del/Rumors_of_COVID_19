...
input_content = getQueryString("content");
father_div_rumor = document.getElementById("rumor_list_x_content");
...
$.ajax({
    ...
    success: function (result) {
        var rumor_list_x_content = document.getElementById('rumor_list_x_content')
