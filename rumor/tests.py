...
# 请求数据
payload = {'action': 'ask_question', 'question': '我国后续疫苗还免费吗？','question_text': '我国后续疫苗还免费吗？'}
...
getload = {"action": 'ask_question', 'title':'北京的新冠肺炎消失了?','date':'2020-04-14', "question": "疫苗", 'pagesize': 1, 'pagenum': 1}
